package de.chojo.xivapi.entities.item.sub.classjobuse;
...
import de.chojo.xivapi.entities.item.sub.classjobrepair.refs.ClassJobRepairRef;
import de.chojo.xivapi.entities.item.sub.classjobuse.itemstartingweapon.ClassJobUse;
import de.chojo.xivapi.entities.item.sub.classjobuse.itemstartingweapon.ItemRepairRef;
import de.chojo.xivapi.entities.item.sub.classjobuse.itemstartingweapon.ItemSpecialBonus;

public record ItemStartingWeapon(
	...
	Object baseParamSpecial4,

	@JsonProperty("BaseParamSpecial3")
	Object baseParamSpecial3,

	@JsonProperty("BaseParamSpecial2")
	Object baseParamSpecial2,
    ...
    ClassJobRepairRef classJobRepair,
